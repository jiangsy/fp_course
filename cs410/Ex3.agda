...
_>[_]<_ : {X : Set}{ls ms rs : List X} -> {P : X -> Set} ->
          ...
          All P ms
pl >[ sz ]< pr = <>
(l , pl) >[ sl s ]< pr = l , (pl >[ s ]< pr)
pl >[ sr s ]< (r , pr) = r , (pl >[ s ]< pr)

-- Now, build the view that shows riffling can be inverted, using a splitting
...
isRiffle sz pm = mkRiffle <> <>
isRiffle (sl s) (x , y) with isRiffle s y 
... | mkRiffle pl pr = mkRiffle (x , pl) pr
isRiffle (sr s) (x , y) with isRiffle s y
... | mkRiffle pl pr = mkRiffle pl (x , pr)
