...
Proof.
  ...
  - inversion Hmo.
  - inversion Hmo.
    + subst. constructor. apply Hnm.
    + subst. constructor. apply IHo'. assumption.
Qed.
(** [] *)
...
Proof.
  intros.
  induction n; unfold not in *; intros.
  - inversion H.
  - apply le_S_n in H. apply IHn in H.
    inversion H.
Qed.
(** [] *)
...
Proof.
  ...
  specialize (H 0 1 (le_S 0 0 (le_reflexive 0))).
  inversion H.
Qed.
(** [] *)
...
Theorem le_antisymmetric :
  antisymmetric le.
Proof.
  unfold antisymmetric. intro a. induction a; intros.
  - inversion H0. auto.
  - destruct b. 
    + inversion H.
    + apply le_S_n in H0. apply le_S_n in H.
      specialize (IHa b H H0).
...
Theorem le_step : forall n m p,
  ...
  n <= p.
Proof.
  intros n m p Hnm. induction Hnm; intros.
  - apply le_S_n in H. assumption.
  - apply IHHnm. constructor. apply le_S_n. assumption.
Qed.
(** [] *)
...
Lemma rsc_trans :
  forall (X:Type) (R: relation X) (x y z : X),
      ...
      clos_refl_trans_1n R x z.
Proof.
  intros X R x y z. intro Hrxy.
  induction Hrxy.
  - intros; assumption.
  - intros. apply IHHrxy in H.
    eapply rt1n_trans. exact Hxy. assumption.
Qed.
...
Proof.
  ...
  - induction H.
    ...
    + constructor.
    + eapply rsc_trans; eauto.
  - induction H.
    + apply rt_refl.
    + apply rt_step in Hxy. eapply rt_trans; eauto.
Qed.    
